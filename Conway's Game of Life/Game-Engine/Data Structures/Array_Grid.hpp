...
public:
	...
	*/
	Array_Grid(const T& nullData, const size_t& sizeX, const size_t& sizeY);
...
// constructor
template <class T>
Array_Grid<T>::Array_Grid(const T& nullData, const size_t& sizeX, const size_t& sizeY) : mNullData(nullData)
{
	this->mSize.x = sizeX;
	this->mSize.y = sizeY;
...
// copy constructor
template <class T>
Array_Grid<T>::Array_Grid(const Array_Grid& copy) : mNullData(copy.mNullData)
{
...
template <class T>
void Array_Grid<T>::setNullData(const T& newNullData)
{
...
template <class T>
inline const T& Array_Grid<T>::getNullData() const
{
...
// checks
template <class T>
bool Array_Grid<T>::empty() const								// is list empty
{
...
template <class T>
bool Array_Grid<T>::isInArray(const size_t& whereX, const size_t& whereY) const
{
